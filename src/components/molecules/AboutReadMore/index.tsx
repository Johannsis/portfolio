...
function AboutReadMore(): React.ReactElement {
  return (
    <details className="group grid grid-cols-1 gap-4">
      <summary className="body-xs text-primary-100 border-secondary-100/30 bg-primary-20/30 order-2 col-start-1 w-fit cursor-pointer list-none rounded-xl border px-3 py-2 leading-6 transition-all duration-300 [&::-webkit-details-marker]:hidden">
        <span className="group-open:hidden">Read More</span>
        <span className="hidden group-open:inline">Show Less</span>
      </summary>
      <div className="body-xs text-primary-80 col-start-1 grid gap-4 overflow-hidden leading-relaxed font-normal">
        <p>
          Currently, I&apos;m a{' '}
